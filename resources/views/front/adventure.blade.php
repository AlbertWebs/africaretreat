    ...
    <div class="container container-custom margin_80_55 wow" data-wow-offset="250" id="secret">
        ...
        <section class="wow slideInUp" data-wow-duration="2s">
            <div class="main_title_3" >
                <span><em></em></span>
                <h2 style="text-transform: capitalize">{{$page_title}}</h2>
   
            </div>
           
            <div class="row">
                @foreach ($Destinations as $exp)
                <div class="col-xl-4 col-lg-6 col-md-6" style="margin:0px auto">
                    <a href="{{url('')}}/itineraries/{{$exp->slung}}" class="grid_item latest_adventure">
                        <figure>
                            {{-- <div class="score"><strong>8.5</strong></div> --}}
                            <img style="min-height:233px;" src="{{url('/')}}/uploads/samples/{{$exp->image_one}}" class="img-fluid" alt="">
                            <div class="info">
                                {{-- <em>{{$exp->duration}}</em> --}}
                                <h3>{{$exp->title}}</h3>
                            </div>
