...
<head>
    ...
    <meta name="description" content="Africa Retreat Tours and Travels | Mission Safaris In Kenya">
	...
	<header class="header menu_fixed">
		...
		<div id="logo">
			<a href="{{url('/')}}">
				...
				<img src="{{url('/')}}/uploads/logo/{{$Settings->logoo}}" width="150" height="" alt="" class="logo_sticky">
			</a>
		</div>
		<ul id="top_menu">
