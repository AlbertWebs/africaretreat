...
class HomeController extends Controller
{
    ...
    public function explore_kenya()
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle('Explore Kenya - African Retreat Tours and Travels');
        SEOMeta::setDescription('African Retreat Tours and Travels is all about Mission Trips, Cultural Trips In Kenya,Special Interest Trips. Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/');
    ...
    public function experiences()
    {
        ...
        $Course = DB::table('product')->paginate(9);
        $page_title = 'African Retreat Tours and Travels';
        $Destinations = DB::table('samples')->get();
        return view('front.adventure',compact('Course','page_title','Destinations'));
    }
    ...
    public function credits()
    {
        ...
        SEOMeta::setDescription('African Retreat Tours and Travels is all about Mission Trips, Cultural Trips In Kenya,Special Interest Trips. Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/credits');
        $Course = DB::table('product')->paginate(9);
        $page_title = 'African Retreat Tours and Travels';
    ...
    public function transfers()
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle('Airport Transfers | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/transfers');
        $page_title = 'Car';
    ...
    public function carDescription($id)
    {
        ...
        SEOMeta::setTitle(''.$id.' | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/car/'.$id.'');
    ...
    public function destinations($slung)
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle('Tours and Safaris | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
    ...
    public function destination($name)
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle(''.$name.' | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/tour-package/'.$name.'');
        $page_title = $name;
        $Destinations = DB::table('samples')->where('slung',$name)->get();
        return view('front.destination',compact('page_title','Destinations'));
    }

    public function experience($name)
    {
        $Type = DB::table('types')->where('slung',$name)->get();
        foreach ($Type as $key => $value) {
            ...
            SEOMeta::setTitle(''.$name.' | African Retreat Tours and Travels');
            SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
            SEOMeta::setCanonical('http://africatretreat.com/adventures-and-experiences/'.$name.'');
    ...
    public function beach_holidays()
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
            SEOMeta::setTitle('Beach Holidays | African Retreat Tours and Travels');
            SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
            SEOMeta::setCanonical('http://africatretreat.com/beach-holidays');
            $page_title = 'Car';
      ...
      public function hotels()
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle('Hotels | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/elegant-hotels');
    ...
    public function hotel($name)
    {
        ...
        SEOMeta::setTitle(''.$name.' | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/hotel/'.$name.'');
        $page_title = 'Hotel';
    ...
    public function contact()
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle('Contact Us | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/contact-us');
    ...
    public function books($cat,$id)
    {
        SEOMeta::setTitle('Booking | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/booking/car/'.$id.'');
    ...
    public function about()
    {
        ...
        Session::forget('model');
        Session::forget('check_in');
        SEOMeta::setTitle('About Us | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
    ...
    {
        SEOMeta::setTitle('Terms and Conditions | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/terms-and-conditions');
        $Term = Term::all();
    ...
    public function trading()
    {
        SEOMeta::setTitle('Terms and Conditions | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/trading-terms');
    ...
    {
        SEOMeta::setTitle('Privacy Policy | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/privacy-policy');
        $Privacy = Privacy::all();
    ...
    {
        SEOMeta::setTitle('Copyright Statement | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/copyright');
    ...
    {
        SEOMeta::setTitle('Travel Infomation | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/travel-guide');
    ...
    public function searchsite(Request $request){
        SEOMeta::setTitle('Search | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/');
    ...
    public function searchCar(Request $request){
        SEOMeta::setTitle('Car Search | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/');
        // Used For Session
        $city = $request->city;
    ...
    public function search_transfer_filter(Request $request){
        SEOMeta::setTitle('Airport Transfer Search | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/');
          $mode = $request->mode;
    ...
    public function search_hotel_filter(Request $request){
        SEOMeta::setTitle('Search Hotels | African Retreat Tours and Travels');
        SEOMeta::setDescription('Kenya Safaris,Tanzania Safaris,Uganda Safaris,Zanzibar safaris,Accomodation,Car Hire Services,Transfers, Whatever your tastes ,African Retreat Tours and Travels will find the perfect holiday package for you.');
        SEOMeta::setCanonical('http://africatretreat.com/');
        // Destroy Session
         Session::forget('check_in');
