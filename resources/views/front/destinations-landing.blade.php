...
<main>
    ...
    <div class="bg_color_1">
        <div class="container margin_80_55">
            <div class="main_title_2" style="max-width:600px; margin:0 auto">
                ...
                <p class="bg-white">	&quot; There is something about safari life that makes you forget all your sorrows and feel as if you had drunk half a bottle of champagne — bubbling over with heartfelt gratitude for being alive &quot; <br>
              <strong>Wander  .  Explore  .  Discover</strong> </p>
              <br><br>
              <i style="font-size: 1.5rem;">~Karen Blixen</i>
            </div>
        </div>
    </div>
    {{--  </TextArea>--}}
    ...
    <div class="margin_60_35" style="padding:10px">
        ...
        <div class="row wow slideInUp" data-wow-duration="1.2s" >
            ...
            <div class="col-xl-4 col-lg-6 col-md-6" style="margin:0 auto">
                <a href="{{url('')}}/destinations/{{$country->slung}}" class="grid_item latest_adventure">
                    <figure style="max-height:364px">
                        ...
                        <img style="min-height:353px; height:100%" src="{{url('/')}}/uploads/countries/{{$country->image}}" class="img-fluid" alt="">
