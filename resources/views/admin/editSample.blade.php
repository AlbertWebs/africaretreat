				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select name="type" data-placeholder="Select Type" class="form-control chzn-select" tabindex="2">
                            <option selected value="{{$Sample->type}}">{{$Sample->type}}</option>
                               <?php $TheCategoryList = DB::table('types')->get(); ?>
                               @foreach($TheCategoryList as $value) 
