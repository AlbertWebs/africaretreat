...
//Tags
Route::get('/tags','AdminsController@tags');
Route::get('/editTag/{id}','AdminsController@editTag');
Route::get('/deleteTag/{id}','AdminsController@deleteTag');
Route::post('/edit_Tag/{id}', 'AdminsController@edit_Tag');
Route::get('/addTag', 'AdminsController@addTag');
Route::post('/add_Tag', 'AdminsController@add_Tag');

Route::get('/slung-update', 'AdminsController@addSlung');
